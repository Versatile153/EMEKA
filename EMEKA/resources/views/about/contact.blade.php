...
<meta name="description" content="To contact our amazing customer support team, use this contact form." />
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, shrink-to-fit=no" />
<meta itemprop="name" content="Contact Customer Service | The Motley Fool">
<meta itemprop="description" content="To contact our amazing customer support team, use this contact form.">
<meta name="twitter:site" content="@themotleyfool">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Contact Customer Service | The Motley Fool">
<meta name="twitter:description" content="To contact our amazing customer support team, use this contact form.">
<meta property="og:site_name" content="The Motley Fool" />
<meta property="og:title" content="Contact Customer Service | The Motley Fool" />
<meta property="og:url" content="https://www.fool.com/contact/customer-service/" />
<meta property="og:description" content="To contact our amazing customer support team, use this contact form." />
...
<title>
    ...
    Contact Customer Service | The Motley Fool
...
<link rel="canonical" href="https://www.fool.com/contact/customer-service/">
...
<script type="text/javascript">
    var dataLayer = dataLayer || [];
        ...
        dataLayer.push({'articleUUID': 'df53ed18-710a-41fa-b1a6-6faa9e0e5a59' });
...
<header>
<h1 class="font-medium text-gray-1100 leading-relative-2 md:text-h1 md:py-8px">Contact Customer Service</h1>
</header>
</div>
<div class="-mx-24px md:-mx-40px h-16px bg-gradient-to-b from-transparent to-gray-200"></div>
</section>
<section class="bg-white mx-24px md:mx-0px md:px-40px">
<div class="mx-auto lg:flex max-w-1280">
<div class="text-xl xl:w-2/3 lg:mb-64 text-gray-1100">
<p data-block-key="j9rdw"></p><p data-block-key="el9jv"></p><p data-block-key="6rgt1"><b>Got a question for our customer service team?</b></p><p data-block-key="97ti2"><a href="https://support.fool.com/hc/en-us"><b>Check out our help center to find some of the most commonly asked questions!</b></a></p><p data-block-key="bgt1o">Our most common question, answered here:</p><p data-block-key="6fuvq"><a href="https://www.fool.com/auth/ml/link/?destination=http%3a%2f%2fwww.fool.com%2f">How do I recover my Motley Fool password or user name?</a></p>
</div>
<div class="h-full border border-gray-300 xl:w-1/3 mb-80 lg:ml-24px p-24px shadow-card mt-48px">
<form class="contact-form" action="/contact/customer-service/" method="POST">
<div class="flex justify-between border-b border-gray-300 pb-4px mb-16px">
<h3 class="text-xl font-light leading-snug text-gray-1100 pb-12px">Contact The Motley Fool</h3>
...
<input type="hidden" name="csrfmiddlewaretoken" value="ikHFGVbdJ30rrksu2a6KE7yHKWCEIxUie3czFyguvKKLJLnXuScD8Jv4YX69cPo4">
<div>
<div class="flex flex-column mt-12px">
<label class="font-bold uppercase font-md text-gray-1100" for="id_first_name">
First Name
</label>
</div>
<div>
...
<div>
<div class="flex flex-column mt-12px">
<label class="font-bold uppercase font-md text-gray-1100" for="id_last_name">
Last Name
</label>
</div>
<div>
...
<div>
<div class="flex flex-column mt-12px">
<label class="font-bold uppercase font-md text-gray-1100" for="id_postal_code">
Postal Code
</label>
</div>
<div>
...
<div>
<div class="flex flex-column mt-12px">
<label class="font-bold uppercase font-md text-gray-1100" for="id_email_address_of_your_subscription">
Email address of your subscription
</label>
</div>
<div>
<input type="email" name="email_address_of_your_subscription" required id="id_email_address_of_your_subscription">
<p class="help">If you are a subscriber, please include the email that you use to login to your service.</p>
</div>
</div>
<div>
<div class="flex flex-column mt-12px">
<label class="font-bold uppercase font-md text-gray-1100" for="id_your_phone">
Your Phone
</label>
</div>
<div>
<input type="text" name="your_phone" maxlength="255" id="id_your_phone">
</div>
</div>
<div>
<div class="flex flex-column mt-12px">
<label class="font-bold uppercase font-md text-gray-1100" for="id_your_inquiry">
Your Inquiry
</label>
</div>
<div>
<select name="your_inquiry" required id="id_your_inquiry">
<option value="" selected></option>
<option value="Cancellation &amp; Billing">Cancellation &amp; Billing</option>
<option value="Purchase a service">Purchase a service</option>
<option value="More information about The Motley Fool’s services">More information about The Motley Fool’s services</option>
<option value="Trouble logging in">Trouble logging in</option>
<option value="Trouble accessing my services">Trouble accessing my services</option>
<option value="Issue with Scorecard">Issue with Scorecard</option>
<option value="Change my email preferences">Change my email preferences</option>
<option value="Change my account information">Change my account information</option>
<option value="Personal Data Request">Personal Data Request</option>
<option value="European Personal Data Request">European Personal Data Request</option>
...
<div>
<div class="flex flex-column mt-12px">
<label class="font-bold uppercase font-md text-gray-1100" for="id_comments">
Comments
</label>
</div>
<div>
<textarea name="comments" cols="40" rows="10" required id="id_comments"></textarea>
</div>
</div>
<input class="block w-full font-bold text-center text-white rounded cursor-pointer py-12px mt-24px bg-cyan-700 shadow-card hover:bg-cyan-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-opacity-75" type="submit" value="Send Message">
</form>
</div>
</div>
</section>
...
<li><a class="text-gray-700 hover:text-gray-1100" data-action="about" href="/cdn-cgi/l/email-protection#5c3d3835322d29352e35392f1c3a333330723f3331">Advertise</a></li>
</ul>
</div>
<div class="footer-list">
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7c299cec5ae1d7a9","token":"e081e875f70442d4bdc4b24dde150ec9","version":"2023.4.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>
