...
<h1 class="text-h2 md:text-h1 text-gray-1000 mb-0px">What is an NFT?</h1>
<div class="font-medium text-gray-800 text-md md:text-lg mb-16px mt-20px md:my-24px">
By
<a class="text-cyan-800 hover:text-cyan-600 hover:underline" href="https://www.fool.com/author/14525/">Nicholas Rossolillo</a> –
Updated
Apr 21, 2023 at 9:50AM
</div>
</div>
...
<p data-block-key="qnmef">Cryptocurrencies have been skyrocketing in recent years, but these digital assets have more to them than just rampant speculation. Blockchain -- the digital ledger technology that enables cryptos -- has actual, real-world use. Non-fungible tokens (NFTs) are one example. NFTs are tokens based on a blockchain that represent ownership of a <a href="/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/digital-assets/">digital asset</a>. The recent craze in NFTs involves digital art and creation (for example, <b>Twitter </b>(<a href="/quote/nyse/twtr/">NYSE:TWTR</a>) CEO Jack Dorsey sold the first-ever published tweet for $2.9 million via an NFT).</p><p data-block-key="27v4s">Sound silly? Perhaps. But there&#x27;s more to the discussion around NFTs than meets the eye.</p>
</section>
...
<video-js data-account="6275808953001" data-player="DYFhYcJnZ" data-embed="default" controls="" data-video-id="6297636839001" class="vjs-fluid"></video-js>
</div>
<script src="https://players.brightcove.net/6275808953001/DYFhYcJnZ_default/index.min.js"></script>
</section>
<section class="block-paragraph">
<h2 data-block-key="qv093">What are non-fungible tokens (NFTs)?</h2><p data-block-key="9m3e">Non-fungible tokens aren&#x27;t actual cryptocurrencies in the same sense as <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/bitcoin/"><b>Bitcoin</b></a> (<span class="font-bold whitespace-nowrap" data-id="343539"><a href="/quote/crypto/btc/">BTC</a> <span class="text-red-900 ticker-change"> -0.22%</span></span>). Cryptocurrencies utilize <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/blockchain-stocks/how-to-invest/">blockchain</a> for its ability to track financial transactions between parties and were designed as a type of digital currency for use on the internet and in a digital-first world.</p><p data-block-key="bg1kd">NFTs are also built on a blockchain but instead are used to guarantee ownership of an asset. Think of it as a certificate such as an auto or real estate title stating the legal owner of a car or home, except that an NFT is proof of ownership in digital form. Most NFTs are based on the <a href="/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/ethereum-stock/"><b>Ethereum</b></a> (<span class="font-bold whitespace-nowrap" data-id="343717"><a href="/quote/crypto/eth/">ETH</a> <span class="text-red-900 ticker-change"> -0.16%</span></span>) blockchain network.</p><p data-block-key="f9lhi">An NFT is a unique digital asset that is not directly replaceable with another digital asset (thus the name &quot;non-fungible&quot;). Many physical assets are also non-fungible. Real estate, for example, is non-fungible since each piece of property is unique from others.</p><p data-block-key="djpc9">A &quot;fungible&quot; token, by contrast, is one that is replaceable with another one identical to it. Ether is the fungible token that trades on the Ethereum network, meaning one Ether is identical to another. The same goes for Bitcoin. One Bitcoin can be exchanged for another Bitcoin because they have the same value. Physical currencies work this way, too. One physical dollar bill is the same as another dollar bill, and thus each are &quot;fungible.&quot; But each NFT is unique; there isn&#x27;t another one exactly like it out there, so they are non-fungible -- or unable to exactly replace another.</p><p data-block-key="fps3r">Code is written into this digital token and recorded using the blockchain network it&#x27;s based on (again, usually on Ethereum) to prove a list of historical ownership and the current owner of a unique digital asset. An NFT can represent any digital creation -- art, music, videos, writing, etc.</p>
</section>
<section class="block-image">
<div class="img-with-caption">
<img src="https://m.foolcdn.com/media/dubs/images/NFT_non_fungible_token.width-880.jpg" width="880" alt="NFT non fungible token" loading="lazy">
<div class="not-italic text-gray-600 text-md mb-32px">Source: Getty Images</div>
</div>
</section>
<section class="block-paragraph">
<h2 data-block-key="y6zor">How many NFTs are there?</h2><p data-block-key="19at0">At the end of October 2021, there were nearly 7,000 <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/types-of-cryptocurrencies/">different types of cryptocurrencies</a> worldwide. Most NFTs are built on Ethereum, but many of these tokens utilize a different blockchain or were <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/non-fungible-tokens/how-to-buy-nfts/">built on a proprietary NFT platform</a>. As a result, there are innumerable individual NFTs representing works of art, videos, <a href="/investing/stock-market/market-sectors/communication/video-game-stocks/">video game</a> content, <a href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/music-nfts/">music</a>, and more. As more artists and creators make use of NFTs to secure and monetize their work, this number will only increase over time.</p>
</section>
<section class="block-pitch">
<div id="foolcom-wagtail-in_line_article_pitch" data-pitch-placement="in_line_article_pitch"></div>
</section>
<section class="block-paragraph">
<p data-block-key="78f13"></p><h2 data-block-key="bfi51">How do NFTs work?</h2><p data-block-key="hum5">How exactly are NFTs used? Digital art collections, for one. In March 2021, an NFT representing an image, &quot;Everydays: The First 5,000 Days,&quot; by artist Beeple was auctioned by Christie&#x27;s for $69 million. The purchaser of the NFT now has ownership of the digital art attached to it. Digital creators Larva Labs auctioned off individual CryptoPunks characters in 2017; some of the NFTs are now worth millions of dollars.</p><p data-block-key="anrvk">These are some extreme examples of ballooning NFT values. For common functionality, though, artists can use NFTs to sell their creations to collectors and other digital creators. An owner or creator of an NFT can also collect royalties for the art&#x27;s copy or use online. NFTs hold promise as a way to enforce digital copyright and trademark law.</p><p data-block-key="8flj">Real-world use cases abound, too. <b>Nike </b>(<span class="font-bold whitespace-nowrap" data-id="204702"><a href="/quote/nyse/nke/">NKE</a> <span class="text-red-900 ticker-change"> -2.42%</span></span>) owns a patent on NFTs to authenticate sneakers as unique items. But outside the realm of collectors&#x27; items (a form of modern fine art speculation), NFTs could have some practical, everyday value. Remember the aforementioned titling of physical assets such as cars or real estate? <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/blockchain-stocks/">Blockchain</a>-based tokens could be used to guarantee ownership of physical property and cut out expensive intermediaries who traditionally handle titling services and related legal documentation. It&#x27;s still early days for NFTs, though, so more ideas could emerge in the years ahead.</p>
</section>
...
<section class="block-paragraph">
<h2 data-block-key="kjpna">Why are non-fungible tokens important?</h2><p data-block-key="b7dv0">Besides representing a way for digital artists and other creators to monetize their work, NFTs are imagined as the evolution of <a href="https://www.fool.com/investing/stock-market/market-sectors/communication/media-stocks/art-investment/">art investing and collecting</a> and as part of a new cryptocurrency investment asset class. Since an NFT is unique, there&#x27;s always a slim chance an NFT collection could balloon in value (like Beeple&#x27;s digital artwork). If you&#x27;re an art collector, NFTs are easy to buy and sell on an online marketplace such as OpenSea. Cryptocurrency <a href="https://www.fool.com/investing/how-to-invest/stocks/best-investment-apps/">trading app</a> Binance is launching an <a href="https://www.fool.com/the-ascent/cryptocurrency/nft-marketplaces/">NFT marketplace</a>, and <b>Coinbase Global</b> (<span class="font-bold whitespace-nowrap" data-id="344268"><a href="/quote/nasdaq/coin/">COIN</a> <span class="text-green-900 ticker-change"> 1.5%</span></span>) might do the same (it has invested in several NFT marketplaces, including Rarible).</p><p data-block-key="8cdd">But, for the average investor, <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/non-fungible-tokens/how-to-buy-nft/">NFTs represent a highly speculative</a> class of investment that should probably be avoided. NFTs don&#x27;t gain in value because of their utility but are based on the value of the media they represent (digital art, video, music, etc.). Sticking a value on something like art is incredibly difficult and subjective and unlike valuing a share of stock, which represents an ownership stake in a business and a <a href="https://www.fool.com/investing/how-to-invest/time-value-money/">claim on future profits</a> generated by the business.</p>
</section>
<section class="block-paragraph">
<h2 data-block-key="kjpna">Related investing topics</h2>
</section>
...
<a class="block h-full p-16px border-t-4px border-cyan-700 hover:border-cyan-600" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-games/">
<h4 class="font-bold text-md ">
Investing in NFT Games
</h4>
<p>Play the market for NFT games, an increasingly popular trend.</p>
</a>
</div>
<div class="border border-gray-300 shadow-card mb-24px md:mb-0px">
<a class="block h-full p-16px border-t-4px border-cyan-700 hover:border-cyan-600" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/how-to-make-an-nft/">
<h4 class="font-bold text-md ">
How to Make an NFT
</h4>
<p>Learn to design, produce, market, and sell your own NFTs.</p>
</a>
</div>
<div class="border border-gray-300 shadow-card mb-24px md:mb-0px">
<a class="block h-full p-16px border-t-4px border-cyan-700 hover:border-cyan-600" href="/investing/stock-market/types-of-stocks/small-cap-stocks/">
<h4 class="font-bold text-md ">
Top Small-Cap Stocks to Buy
</h4>
<p>The smaller companies in the stock market might make for big returns.</p>
</a>
</div>
<div class="border border-gray-300 shadow-card mb-24px md:mb-0px">
<a class="block h-full p-16px border-t-4px border-cyan-700 hover:border-cyan-600" href="/investing/stock-market/market-sectors/financials/fintech-stocks/">
<h4 class="font-bold text-md ">
Investing in Top FinTech Companies
</h4>
<p>Combine finance and technology and you get companies in this space.</p>
</a>
</div>
</div>
</section>
<section class="block-paragraph">
<p data-block-key="vzl7v">Investors who want some indirect exposure to NFTs anyway might consider adding a little Ether to their portfolio since most NFTs utilize the Ethereum network&#x27;s blockchain. Ether is also a highly speculative investment, although it could increase in value if Ethereum network use rises over time. (It&#x27;s important to note there is no cap on how many tokens of Ether can exist, but a recent change to the way transactions are validated from <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/proof-of-work/">proof of work</a> to <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/proof-of-stake/">proof of stake</a> should decrease the supply of Ethereum over time.)  </p><p data-block-key="47dth">Even so, non-fungible tokens could be an important technological development. In a new digital era that blurs the lines between the physical and virtual worlds, a new way to track digital asset ownership and distribution online will be increasingly important. These blockchain-based tokens could also disrupt <a href="https://www.fool.com/investing/stock-market/market-sectors/financials/">financial intermediaries</a> and lower the cost of buying and selling big-ticket items such as autos and real estate. That doesn&#x27;t necessarily mean you should invest in highly speculative NFTs, but, at the very least, their development is worth keeping an eye on.</p>
</section>
<section class="block-pitch">
<div id="foolcom-wagtail-article_pitch" data-pitch-placement="article_pitch"></div>
</section>
<section class="block-expert_qa">
<div class="my-48 wagtail-block">
<h2>Exclusive NFT Q&amp;A with outside experts</h2>
<div class="qna">
<div class="flex justify-between py-24 border-b border-gray-400 md:items-center qna-header hub-expertqa">
<div class="items-center md:flex">
<img alt="DR. MERAV OZAIR" class="mb-12 mr-16 rounded-full md:mb-0" height="80" loading="lazy" src="https://m.foolcdn.com/media/dubs/images/DR._MERAV_OZAIR.2e16d0ba.fill-80x80-c100.png" width="80">
<div>
<h3 class="text-gray-1100 text-24 mb-4px">Dr. Merav Ozair</h3>
<div class="font-sans text-14">FINTECH FACULTY MEMBER, RUTGERS BUSINESS SCHOOL</div>
</div>
</div>
...
<div class="qna-content pt-16px">
<p data-block-key="qgka1"><b>CapitalCrest:</b> <b><i>NFTs seem to be the new craze this past year, but do you anticipate this trend to continue or do you foresee NFTs being just another bubble? Why?</i></b></p><p data-block-key="a201d"><b>Dr. Ozair:</b> Whether an asset&#x27;s value is in a &quot;bubble&quot; or not is determined in hindsight. If you are purchasing an NFT as an investment, then the risks associated with it are the same as with any other investment -- whether that&#x27;s stocks, collectibles or real estate. The NFT&#x27;s value may go up or down, depending on market sentiment, conditions, or preferences. Anyone can guess at or believe what the future value will be.</p><p data-block-key="255m4">NFTs might also have a personal or &quot;emotional&quot; value associated with them, like the one-of-kind &quot;GRONK Career Highlight Refractor Card.&quot; This NFT is a collage of four illustrations comprising the other tokens in the collection and is digitally signed by (National Football League star) Rob Gronkowski. The token&#x27;s purchaser received the opportunity to meet the NFL star, two tickets to attend one of his NFL games, and VIP tickets to Gronkowski&#x27;s next beach party event. The &quot;perks&quot; associated with this NFT might be valued only on a personal or emotional level for the purchaser.</p><p data-block-key="e9qda">NFTs are here to stay because the possibilities and the opportunities of NFTs are boundless and go beyond art and celebrities&#x27; tweets or photos. The future of NFTs lies in business applications -- as the true power of NFTs is providing authentication and facilitating the transfer of ownership. Thus, you can tokenize a bottle of wine, a Gucci bag, a property, or any physical or digital asset that is deemed unique.</p><p data-block-key="2vo9h"><b>CapitalCrest:</b> <b><i>NFTs are often images or videos that anyone on the internet can view, but the owner of that NFT has the &quot;original,&quot; meaning the value of that NFT is based solely on what someone is willing to pay for it. That said, do you think it&#x27;s worth adding NFTs to your investment portfolio when the value is so subjective?</i></b></p><p data-block-key="d4fa2"><b>Dr. Ozair:</b> You can ask the same question about purchasing art or any collectible -- baseball cards, paintings, jewelry, or wine. It&#x27;s the feelings of ownership and pride that incentivizes people to purchase a collectible.</p><p data-block-key="74ipb">Some may view [unique assets that they own] as investments. Unique assets like Picasso paintings or rare baseball cards may increase in value in the future, like the 1952 Mickey Mantle baseball card from Topps that sold for $5.2 million. In this tokenized world in which anything can be digitized, Twitter CEO Jack Dorsey sold his first tweet as an NFT for $2.9 million.</p><p data-block-key="8voa4">A real estate property could be an NFT, with its investment value tied to the real estate&#x27;s property value. In fact, [tokenizing] a real estate property would actually increase its value by adding liquidity.</p><p data-block-key="bbef"><b>CapitalCrest:</b> <b><i>What are some things investors should consider when looking to purchase an NFT (e.g., capital gains taxes, use of cryptocurrency, valuation, etc.)?</i></b></p><p data-block-key="bqudm"><b>Dr. Ozair:</b> If you are considering an NFT as an investor, not as a collector, then you should approach it like any investment. Who is the creator of the NFT? Does it have the potential to increase in value due to the reputation of the creator, its rarity, or [history of] ownership? On which auction platform is the NFT auctioned? Is it tradeable or liquid?</p><p data-block-key="dgu3">NFTs are not regulated yet. But regulators, especially in Europe, have already put forward some proposals. The U.S. has yet to follow suit. Regulation for NFTs may have implications on how they are classified and where and if they can be traded.</p><p data-block-key="1f7dt">NFT creators pay income tax, while NFT investors are subject to [the standard] capital gain rules.</p><p data-block-key="cpiah">Most -- if not all -- NFT platforms use cryptocurrency to trade NFTs. Since the value of an NFT is quoted in cryptocurrency, the risk includes exposure to the fluctuation of the cryptocurrency&#x27;s value, [in addition to the risk that the] NFT as an asset will lose value.</p><p data-block-key="6s007">A few new platforms, like Circle and Rarible, will soon provide the ability to purchase NFTs with fiat money. This would eliminate, or at least decrease, the exposure to cryptocurrency value fluctuations. [These platforms can also] facilitate NFT transactions, which makes NFTs more appealing to the mainstream and likely can increase NFTs&#x27; liquidity and value.</p>
</div>
</div>
<div class="qna">
<div class="flex justify-between py-24 border-b border-gray-400 md:items-center qna-header hub-expertqa">
<div class="items-center md:flex">
<img alt="Dr. Will Cong" class="mb-12 mr-16 rounded-full md:mb-0" height="80" loading="lazy" src="https://m.foolcdn.com/media/dubs/images/Dr._Will_Cong.2e16d0ba.fill-80x80-c100.png" width="80">
<div>
<h3 class="text-gray-1100 text-24 mb-4px">Dr. Will Cong</h3>
<div class="font-sans text-14">FACULTY DIRECTOR OF THE FINTECH INITIATIVE, CORNELL UNIVERSITY</div>
</div>
</div>
<svg class="collapsed-icon w-24px h-24px ml-4px" viewBox="0 0 320 512">
<title>angle-down</title>
...
<div class="qna-content pt-16px">
<p data-block-key="ed7up"><b>CapitalCrest:</b> <b><i>NFTs seem to be the new craze this past year, but do you anticipate this trend to continue or do you foresee NFTs being just another bubble? Why?</i></b> </p><p data-block-key="2hpmb"><b>Dr. Cong:</b> It is hard to predict if NFTs will continue attracting as much attention as they have in the past year, but I do not view [the past year] as a bubble. NFTs are an innovation that have attracted a lot of speculation. There are several reasons why NFTs are interesting:</p><ol><li data-block-key="9vq">Non-digital art -- and even some digital arts -- face difficulties of authentication, which reduces ownership utility because it&#x27;s hard to know if a piece [that an investor owns] is fake or authentic. Blockchain technology addresses this authentication issue, [and because of that] value from ownership could be enhanced.</li><li data-block-key="do9i3">Tokenization also expands ownership possibilities. Instead of one person owning an artwork, 500 people could own it, each deriving some ownership utility. The total ownership utility may not be 500 times bigger because exclusivity of ownership is reduced and so is the prestige, but the [total ownership utility] is still bigger than one person&#x27;s utility of ownership. So, again, total value of ownership could improve using NFTs. This is not [yet] what we see in practice, but NFT technology is ripe [for this to occur].</li><li data-block-key="c3f1a">By making [asset] ownership divisible and, thus, more tradable, there is a liquidity improvement and potential risk reduction. Tokenization also boosts [an asset&#x27;s] value due to the crowd-based nature of the transaction. [As with] crowdfunding, there can be learning and herding with crowds, so [an asset&#x27;s] overall valuation could become inflated due to investors&#x27; behaviors. For the liquidity improvement, consider that traditional art pieces are hard to trade, so even if someone values an artwork more than the current owner, the high transaction costs and [associated] effort [negate the value of] a transaction. Ownership can be easily divided and traded [using NFTs] and [fund managers] can rebundle that ownership into digital art ETFs, for which they can issue new NFTs. This allows for diversification [and lowers] the risks associated with the fluctuation of asset prices. Rebundling can also lead to opacity and create problems similar to [those underlying] the subprime [mortgage] crisis.</li><li data-block-key="mm1i">Crypto tokens overall have been gaining value. Because crypto tokens and digital currencies are gaining momentum, investors are more open to owning tokens and are speculating about NFTs. Overall sentiment is positive and there is limited shorting of NFTs, which further adds to the higher market valuation of non-fungible tokens.</li><li data-block-key="e7uoa">So far, little attention has been paid to the viewership utility of digital art pieces. Depending on how the digital art is stored, fragmented ownership may preclude people from viewing the whole piece of art. The NFT industry may come up with additional arrangements to grant or rent the viewership right, especially for art pieces with high viewership utility. </li><li data-block-key="830ia">Another issue with the tokenization of art pieces [relates to energy usage]. If tokenization leads to more proof-of-work-based mining, then [the rise of NFTs] could lead to greater environmental damage and electricity costs.</li></ol><p data-block-key="6rn1e"><b>CapitalCrest:</b> <b><i>NFTs are often images or videos that anyone on the internet can view, but the owner of that NFT has the &quot;original,&quot; meaning the value of that NFT is based solely on what someone is willing to pay for it. That said, do you think it&#x27;s worth adding NFTs to your investment portfolio when the value is so subjective?</i></b></p><p data-block-key="forhg"><b>Dr. Cong:</b> With traditional art, some owners never display an art piece [and never] profit from others viewing it. The ownership itself is delivering utility to the owner. NFTs for images or videos can be treated similarly. Investors who want to include some art pieces in their portfolios without deriving profits from exhibiting them may as well [own] some NFTs. There are many speculative assets with subjective valuations, and NFTs fall into that category. </p><p data-block-key="721ir">It could be interesting to see how the NFT industry evolves. Once offline and off-blockchain, [assets] such as real estate or a physical piece of art can be linked to NFTs, then NFTs can verify ownership of items beyond images and videos. [Real estate and physical art] are not easily duplicated and viewed like [images and videos].</p><p data-block-key="5t3mr"><b>CapitalCrest:</b> <b><i>What are some things investors should consider when looking to purchase an NFT (i.e. capital gains taxes, use of cryptocurrency, valuation, etc.)?</i></b></p><p data-block-key="1r4cq"><b>Dr. Cong:</b> Investors should think carefully, whether they are seeking capital gains or deriving ownership utility, when they purchase NFTs. Taxes are important to consider, as well as the fundamental valuations of crypto tokens. User adoption of a platform and the token supply policy also play a role. NFTs that are linked to physical art pieces or properties [are safer investments] than NFTs of someone&#x27;s tweets.</p>
</div>
</div>
<div class="qna">
<div class="flex justify-between py-24 border-b border-gray-400 md:items-center qna-header hub-expertqa">
<div class="items-center md:flex">
<img alt="Dr. Jimmie Lenz" class="mb-12 mr-16 rounded-full md:mb-0" height="80" loading="lazy" src="https://m.foolcdn.com/media/dubs/images/Dr._Jimmie_Lenz.2e16d0ba.fill-80x80-c100.png" width="80">
<div>
<h3 class="text-gray-1100 text-24 mb-4px">Dr. Jimmie Lenz</h3>
<div class="font-sans text-14">Director, Master of Engineering in FinTech, Duke University</div>
</div>
</div>
<svg class="collapsed-icon w-24px h-24px ml-4px" viewBox="0 0 320 512">
<title>angle-down</title>
...
<div class="qna-content pt-16px">
<p data-block-key="1f0s3"><b>CapitalCrest:</b> <b><i>NFTs seem to be the new craze this past year, but do you anticipate this trend to continue or do you foresee NFTs being just another bubble? Why?</i></b> </p><p data-block-key="bd43c"><b>Dr. Lenz:</b> The inverse of a bubble, I see that the surface of NFT usage is just being scratched. The opportunity to use the NFT format for other types of offerings is just now being analyzed. People are thinking about NFTs as a product rather than a software that can facilitate much more than a specific product offering.</p><p data-block-key="8h04u">This idea of &quot;NFTs as software&quot; is very important. The generic use [potential] of the NFT is not only very broad but also subject to interpretation.</p><p data-block-key="fhc2t"><b>CapitalCrest:</b> <b><i>NFTs are often images or videos that anyone on the internet can view, but the owner of that NFT has the &quot;original,&quot; meaning the value of that NFT is based solely on what someone is willing to pay for it. That said, do you think it&#x27;s worth adding NFTs to your investment portfolio when the value is so subjective?</i></b></p><p data-block-key="3bf68"><b>Dr. Lenz:</b> Thinking about NFTs as just a specific product is inaccurate. But in terms of specific [digital] images [with NFT ownership], a similar asset type might be a famous painting that is often copied.</p><p data-block-key="dsl2a"><b>CapitalCrest:</b> <b><i>What are some things investors should consider when looking to purchase an NFT (e.g., capital gains taxes, use of cryptocurrency, valuation, etc.)?</i></b></p><p data-block-key="5s7lf"><b>Dr. Lenz:</b> Investors in NFTs that represent certain images should take into account all of the factors that would be considered [for any investment] in a similar asset type. Liquidity is of course very different for NFTs than most other image assets.</p><p data-block-key="eu00e">There is very little doubt that NFTs will proliferate as an avenue to [purchasing] other types of offerings. NFTs [could provide] a new way to view &quot;pay per view,&quot; perhaps.</p>
</div>
</div>
</div>
</section>
<div class="text-gray-700 border-gray-300 md:border-b-0px text-md border-b-1px mb-32px lg:mb-0px pb-32px lg:pb-0px">
<a href="https://www.fool.com/author/14525/">Nicholas Rossolillo</a> has positions in Bitcoin, Coinbase Global, and Ethereum. CapitalCrest has positions in and recommends Bitcoin, Coinbase Global, Ethereum, and Nike. CapitalCrest recommends the following options: long January 2025 $47.50 calls on Nike. CapitalCrest has a <a href="https://www.fool.com/legal/fool-disclosure-policy/">disclosure policy</a>.
</div>
...
<a class="flex items-center hover:text-cyan-800 text-gray-1100 gap-x-12" href="https://www.fool.com/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/">
<img style="height:52px;width:92px;overflow:hidden" width="92" height="52" class="flex-none object-cover" src="https://m.foolcdn.com/media/dubs/images/cryptocurrency-stocks-infographic.width-200.png" alt="A graphic showing different cryptocurrency coins as plants sprouting from the ground with an arrow pointing upward." loading="lazy">
<div class="font-medium leading-tight text-md">Investing in Cryptocurrency</div>
</a>
...
<div class="pb-32px">
<h4 class="font-light text-h4 mb-20px mt-24px text-gray-1100">You Might Also Like:</h4>
...
<a class="flex items-center hover:text-cyan-800 text-gray-1100 gap-x-12" href="https://www.fool.com/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/what-is-staking/">
<img style="width:166px;height:99px" width="166" height="99" class="flex-none object-cover" alt="Multiple cryptocurrency logos emerging from a smartphone screen." src="https://m.foolcdn.com/media/dubs/images/Multiple_cryptocurrency_logos_emerging_from_a_.width-400.jpg" loading="lazy">
<h5 class="text-xl font-medium leading-tight md:text-h5">What Is Staking in Crypto?</h5>
</a>
...
<a class="flex items-center hover:text-cyan-800 text-gray-1100 gap-x-12" href="https://www.fool.com/investing/stock-market/market-sectors/financials/cryptocurrency-stocks/proof-of-work/">
<img style="width:166px;height:99px" width="166" height="99" class="flex-none object-cover" alt="A person sitting at home and using laptop." src="https://m.foolcdn.com/media/dubs/images/woman-at-home-computer.width-400.jpg" loading="lazy">
<h5 class="text-xl font-medium leading-tight md:text-h5">Proof of Work (PoW) in Crypto</h5>
</a>
</div>
</div>
...
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/bored-ape-yacht-club/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What is Bored Ape Yacht Club?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="NFT non fungible token" src="https://m.foolcdn.com/media/dubs/images/NFT_non_fungible_token.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What is Bored Ape Yacht Club?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/cryptokitties/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What is CryptoKitties?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="The letters NFT over a digital background" src="https://m.foolcdn.com/media/dubs/images/NFT.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What is CryptoKitties?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/mutant-ape-yacht-club/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What is Mutant Ape Yacht Club?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="abstract grid with word cloud, concept of NFT, non fungible token and crypto art (3d render)" src="https://m.foolcdn.com/media/dubs/images/NFT_grid_image.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What is Mutant Ape Yacht Club?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/clone-x-x-takashi-murakami/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What is Clone X-X Takashi Murakami?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Cloud computing, NFT, AI, artificial intelligence" src="https://m.foolcdn.com/media/dubs/images/NFT_cloud_computing.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What is Clone X-X Takashi Murakami?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/azuki/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What is Azuki NFT?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="The letters NFT over a digital background" src="https://m.foolcdn.com/media/dubs/images/NFT.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What is Azuki NFT?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-gas-fees/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="NFT Gas Fees Explained">
<div class="bg-gray-100">
...
<div class="font-medium leading-normal text-h5 mt-16px">NFT Gas Fees Explained</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-etfs/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in NFT ETFs">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="BlockChain Blocks. Concept. 3D render" src="https://m.foolcdn.com/media/dubs/images/blockchain_blocks.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in NFT ETFs</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/tasty-bones-xyz/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What is Tasty Bones XYZ NFT?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="model skeleton sitting at a desk" src="https://m.foolcdn.com/media/dubs/images/model_skeleton_at_desk_tasty_bones.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What is Tasty Bones XYZ NFT?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/blue-chip-nfts/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in Blue Chip NFTs">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Cartoon human with shopping cart and blue chip stock" src="https://m.foolcdn.com/media/dubs/images/cartoon_blue_chip_stock_page_image_1200x800.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in Blue Chip NFTs</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-worlds/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What is NFT Worlds?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="A busy virtual city rises off of a gridded plane." src="https://m.foolcdn.com/media/dubs/images/not-too-late-to-buy-metaverse-land.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What is NFT Worlds?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/how-to-buy-nft/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="How to Invest, Buy &amp; Sell NFTs from Digital Assets">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Person holding a tablet looking at what stocks to invest in" src="https://m.foolcdn.com/media/dubs/images/Evaluating_what_to_invest_in_1200x700.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">How to Invest, Buy & Sell NFTs from Digital Assets</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-real-estate/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in NFT Real Estate">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="House living smart home" src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_AkKGmin.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in NFT Real Estate</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/poap-nfts/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What Is a POAP?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="People smiling at a conference." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_2HYO2N0.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What Is a POAP?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-art/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in NFT Art">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Someone in an office with a tablet and a computer." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_y6cxuvZ.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in NFT Art</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/cryptopunks-nft/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What Are CryptoPunks?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="A woman placing a picture frame over a phone displaying the word NFT." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_18A1DWf.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What Are CryptoPunks?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-environmental-impact/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="What Is the Environmental Impact of NFTs?">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="A person holding a phone displaying an NFT marketplace." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_C4OyJTy.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">What Is the Environmental Impact of NFTs?</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-games/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in NFT Games">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="A person looking at NFTs." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_MVHDQz1.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in NFT Games</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-minting/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="A Complete Guide to Minting NFTs (Using OpenSea as an Example)">
<div class="bg-gray-100">

<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Female digital artist painting on a digital tablet creating NFT crypto art for marketplace non-fungible token" src="https://m.foolcdn.com/media/dubs/images/NFT_artist_working_at_home.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">A Complete Guide to Minting NFTs (Using OpenSea as an Example)</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/how-to-make-an-nft/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="How to Make an NFT">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="How to Make an NFT" src="https://g.foolcdn.com/misc-assets/carousel_fallback.png" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">How to Make an NFT</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/how-to-sell-nfts/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="How to Sell Non-Fungible Tokens (NFTs)">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Silver dice reading Buy and Sell." src="https://m.foolcdn.com/media/dubs/images/Investing_dice_buy_sell.width-600.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">How to Sell Non-Fungible Tokens (NFTs)</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/how-to-buy-nfts/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="How to Buy Non-Fungible Tokens (NFTs)">
<div class="bg-gray-100">
...
<div class="font-medium leading-normal text-h5 mt-16px">How to Buy Non-Fungible Tokens (NFTs)</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/music-nfts/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in Music NFTs">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Someone singing into a microphone." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_RJGHufm.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in Music NFTs</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/nft-trading-cards/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in NFT Trading Cards">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="A person holding a phone displaying an NFT marketplace." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_C4OyJTy.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in NFT Trading Cards</div>
</a>
<a class="flex-shrink-0 block w-300 lg:w-1/4 px-12px carousel-tile hover:text-cyan-800 text-gray-1100" href="/investing/stock-market/market-sectors/financials/non-fungible-tokens/digital-collectibles/" data-track-category="hubpage-click" data-track-action="child-pages" data-track-link="Investing in Digital Collectibles">
<div class="bg-gray-100">
<img style="height:170px;" width="100%" height="100%" class="block object-cover" alt="Pop-art style drawing of a person holding a smartphone and the word NFT." src="https://m.foolcdn.com/media/dubs/images/original_imageshttpsg.foolcdn.comeditorialimag.width-600_bQrmNBm.jpg" loading="lazy" />
</div>
<div class="font-medium leading-normal text-h5 mt-16px">Investing in Digital Collectibles</div>
</a>
</div>
</div>
...
<li><a class="text-gray-700 hover:text-gray-1100" data-action="about" href="/cdn-cgi/l/email-protection#f09194999e81859982999583b0969f9f9cde939f9d">Advertise</a></li>
</ul>
</div>
<div class="footer-list">
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7c29613aacf1d7b1","token":"e081e875f70442d4bdc4b24dde150ec9","version":"2023.4.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>
